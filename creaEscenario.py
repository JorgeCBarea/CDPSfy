...
################################################################
	...
	#os.system("sudo lxc-attach -n nagios -- wget https://raw.githubusercontent.com/cmaciasjimenez/CDPSfyMV/master/Nagios/s1_nagios2.cfg -P /etc/nagios3/conf.d")
	#os.system("sudo lxc-attach -n nagios -- wget https://raw.githubusercontent.com/cmaciasjimenez/CDPSfyMV/master/Nagios/s2_nagios2.cfg -P /etc/nagios3/conf.d")
	#os.system("sudo lxc-attach -n nagios -- wget https://raw.githubusercontent.com/cmaciasjimenez/CDPSfyMV/master/Nagios/s3_nagios2.cfg -P /etc/nagios3/conf.d")
	#os.system("sudo lxc-attach -n nagios -- wget https://raw.githubusercontent.com/cmaciasjimenez/CDPSfyMV/master/Nagios/s4_nagios2.cfg -P /etc/nagios3/conf.d")
